...
var file_protos_kubeconfig_service_proto_rawDesc = []byte{
	...
	0x45, 0x53, 0x5f, 0x4e, 0x4f, 0x54, 0x4f, 0x4b, 0x10, 0x67, 0x32, 0xc1, 0x05, 0x0a, 0x0a, 0x4b,
	...
	0x69, 0x67, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x51,
	0x5a, 0x4f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x6b, 0x72, 0x61, 0x66, 0x74, 0x6f, 0x6e,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x78, 0x74, 0x72, 0x6d, 0x2f, 0x6b, 0x75, 0x62, 0x65, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x2d, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6e,
	0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x6b, 0x75, 0x62, 0x65, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_protos_kubeconfig_service_proto_depIdxs = []int32{
	...
	6,  // 24: kubeconfig.Kubeconfig.GetAvailableCredResolvers:output_type -> kubeconfig.GetCredResolversRes
	16, // 25: kubeconfig.Kubeconfig.SetCredResolver:output_type -> kubeconfig.CommonRes
	16, // 26: kubeconfig.Kubeconfig.SetCredResolvers:output_type -> kubeconfig.CommonRes
	16, // 27: kubeconfig.Kubeconfig.DeleteCredResolver:output_type -> kubeconfig.CommonRes
	9,  // 28: kubeconfig.Kubeconfig.GetKubeConfig:output_type -> kubeconfig.KubeConfigRes
	16, // 29: kubeconfig.Kubeconfig.SetKubeConfig:output_type -> kubeconfig.CommonRes
	12, // 30: kubeconfig.Kubeconfig.GetAvailableClusters:output_type -> kubeconfig.GetAvailableClustersRes
	16, // 31: kubeconfig.Kubeconfig.RegisterCluster:output_type -> kubeconfig.CommonRes
