...
var file_protos_kubeconfig_service_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x64, 0x22, 0x83, 0x01, 0x0a, 0x10, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x33, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6b, 0x75,
	0x62, 0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52,
	0x65, 0x71, 0x52, 0x09, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a,
	...
	0x18, 0x0a, 0x07, 0x43, 0x61, 0x73, 0x63, 0x61, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x43, 0x61, 0x73, 0x63, 0x61, 0x64, 0x65, 0x2a, 0x45, 0x0a, 0x16, 0x43, 0x72, 0x65,
	...
	0x5f, 0x52, 0x45, 0x53, 0x5f, 0x4e, 0x4f, 0x54, 0x4f, 0x4b, 0x10, 0x67, 0x32, 0xff, 0x04, 0x0a,
...
var file_protos_kubeconfig_service_proto_depIdxs = []int32{
	...
	17, // 19: kubeconfig.Kubeconfig.GetAvailableClusters:input_type -> kubeconfig.CommonReq
	12, // 20: kubeconfig.Kubeconfig.RegisterCluster:input_type -> kubeconfig.RegisterClusterReq
	13, // 21: kubeconfig.Kubeconfig.DeleteCluster:input_type -> kubeconfig.DeleteClusterReq
	17, // 22: kubeconfig.Kubeconfig.SyncAvailableClusters:input_type -> kubeconfig.CommonReq
	17, // 23: kubeconfig.Application.Ping:input_type -> kubeconfig.CommonReq
	17, // 24: kubeconfig.Application.Version:input_type -> kubeconfig.CommonReq
	5,  // 25: kubeconfig.Kubeconfig.GetAvailableCredResolvers:output_type -> kubeconfig.GetCredResolversRes
	...
	11, // 29: kubeconfig.Kubeconfig.GetAvailableClusters:output_type -> kubeconfig.GetAvailableClustersRes
	16, // 30: kubeconfig.Kubeconfig.RegisterCluster:output_type -> kubeconfig.CommonRes
	16, // 31: kubeconfig.Kubeconfig.DeleteCluster:output_type -> kubeconfig.CommonRes
	16, // 32: kubeconfig.Kubeconfig.SyncAvailableClusters:output_type -> kubeconfig.CommonRes
	16, // 33: kubeconfig.Application.Ping:output_type -> kubeconfig.CommonRes
	16, // 34: kubeconfig.Application.Version:output_type -> kubeconfig.CommonRes
