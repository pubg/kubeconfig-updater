...
goog.exportSymbol('proto.kubeconfig.ClusterInformation', null, global);
 ...
 * @constructor
 */
proto.kubeconfig.ClusterInformation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.kubeconfig.ClusterInformation.repeatedFields_, null);
};
goog.inherits(proto.kubeconfig.ClusterInformation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.kubeconfig.ClusterInformation.displayName = 'proto.kubeconfig.ClusterInformation';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.kubeconfig.ClusterInformation.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.kubeconfig.ClusterInformation.prototype.toObject = function(opt_includeInstance) {
  return proto.kubeconfig.ClusterInformation.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.kubeconfig.ClusterInformation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kubeconfig.ClusterInformation.toObject = function(includeInstance, msg) {
  var f, obj = {
    metadata: (f = msg.getMetadata()) && proto.kubeconfig.ClusterMetadata.toObject(includeInstance, f),
    dataresolvertypeList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.kubeconfig.ClusterInformation}
 */
proto.kubeconfig.ClusterInformation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.kubeconfig.ClusterInformation;
  return proto.kubeconfig.ClusterInformation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.kubeconfig.ClusterInformation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.kubeconfig.ClusterInformation}
 */
proto.kubeconfig.ClusterInformation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      for (var i = 0; i < values.length; i++) {
        msg.addDataresolvertype(values[i]);
      }
      break;
    case 3:
 ...
 * @return {!Uint8Array}
 */
proto.kubeconfig.ClusterInformation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.kubeconfig.ClusterInformation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.kubeconfig.ClusterInformation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kubeconfig.ClusterInformation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getDataresolvertypeList();
  if (f.length > 0) {
 ...
 * @return {?proto.kubeconfig.ClusterMetadata}
 */
proto.kubeconfig.ClusterInformation.prototype.getMetadata = function() {
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
*/
proto.kubeconfig.ClusterInformation.prototype.setMetadata = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
 */
proto.kubeconfig.ClusterInformation.prototype.clearMetadata = function() {
 ...
 * @return {boolean}
 */
proto.kubeconfig.ClusterInformation.prototype.hasMetadata = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * repeated MetadataResolverType DataResolverType = 2;
 * @return {!Array<!proto.kubeconfig.MetadataResolverType>}
 */
proto.kubeconfig.ClusterInformation.prototype.getDataresolvertypeList = function() {
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
 */
proto.kubeconfig.ClusterInformation.prototype.setDataresolvertypeList = function(value) {
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
 */
proto.kubeconfig.ClusterInformation.prototype.addDataresolvertype = function(value, opt_index) {
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
 */
proto.kubeconfig.ClusterInformation.prototype.clearDataresolvertypeList = function() {
  return this.setDataresolvertypeList([]);
};
 ...
 */
proto.kubeconfig.ClusterInformation.prototype.getStatus = function() {
 ...
 * @return {!proto.kubeconfig.ClusterInformation} returns this
 */
proto.kubeconfig.ClusterInformation.prototype.setStatus = function(value) {
...
proto.kubeconfig.GetAvailableClustersRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.kubeconfig.ClusterInformation.toObject, includeInstance)
  };
...
proto.kubeconfig.GetAvailableClustersRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.kubeconfig.ClusterInformation;
      reader.readMessage(value,proto.kubeconfig.ClusterInformation.deserializeBinaryFromReader);
...
proto.kubeconfig.GetAvailableClustersRes.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.kubeconfig.ClusterInformation.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated ClusterInformation Clusters = 2;
 * @return {!Array<!proto.kubeconfig.ClusterInformation>}
 */
proto.kubeconfig.GetAvailableClustersRes.prototype.getClustersList = function() {
  return /** @type{!Array<!proto.kubeconfig.ClusterInformation>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.kubeconfig.ClusterInformation, 2));
};


/**
 * @param {!Array<!proto.kubeconfig.ClusterInformation>} value
 * @return {!proto.kubeconfig.GetAvailableClustersRes} returns this
*/
...
/**
 * @param {!proto.kubeconfig.ClusterInformation=} opt_value
 * @param {number=} opt_index
 * @return {!proto.kubeconfig.ClusterInformation}
 */
proto.kubeconfig.GetAvailableClustersRes.prototype.addClusters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.kubeconfig.ClusterInformation, opt_index);
};
