...
goog.exportSymbol('proto.kubeconfig.SetConfigRes', null, global);
 ...
 * @constructor
 */
proto.kubeconfig.SetConfigRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.kubeconfig.SetConfigRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.kubeconfig.SetConfigRes.displayName = 'proto.kubeconfig.SetConfigRes';
}
 ...
 * @return {!Object}
 */
proto.kubeconfig.SetConfigRes.prototype.toObject = function(opt_includeInstance) {
  return proto.kubeconfig.SetConfigRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.kubeconfig.SetConfigRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kubeconfig.SetConfigRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    commonres: (f = msg.getCommonres()) && protos_common_pb.CommonRes.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.kubeconfig.SetConfigRes}
 */
proto.kubeconfig.SetConfigRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.kubeconfig.SetConfigRes;
  return proto.kubeconfig.SetConfigRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.kubeconfig.SetConfigRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.kubeconfig.SetConfigRes}
 */
proto.kubeconfig.SetConfigRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.kubeconfig.SetConfigRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.kubeconfig.SetConfigRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.kubeconfig.SetConfigRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kubeconfig.SetConfigRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCommonres();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.kubeconfig.CommonRes}
 */
proto.kubeconfig.SetConfigRes.prototype.getCommonres = function() {
  return /** @type{?proto.kubeconfig.CommonRes} */ (
    jspb.Message.getWrapperField(this, protos_common_pb.CommonRes, 1));
};
...
/**
 * @param {?proto.kubeconfig.CommonRes|undefined} value
 * @return {!proto.kubeconfig.SetConfigRes} returns this
*/
proto.kubeconfig.SetConfigRes.prototype.setCommonres = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.kubeconfig.SetConfigRes} returns this
 */
proto.kubeconfig.SetConfigRes.prototype.clearCommonres = function() {
  return this.setCommonres(undefined);
};
 ...
 * @return {boolean}
 */
proto.kubeconfig.SetConfigRes.prototype.hasCommonres = function() {
  return jspb.Message.getField(this, 1) != null;
};
